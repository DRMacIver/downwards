...
31 connected floors and 22 persistent coins. The opening Rootworks region begins without traversal
...
six branch coins open the Winged Vault; its alternating hazard-band climb is modelled on the
gallery's “Even Tempo” room and awards Dash. Two more coins open the Treasury, and its final two
open the 22-coin Crown gate. The Crown ingress explicitly requires both unlocked traversal

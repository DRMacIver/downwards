...
pub use demo_dungeon::{
    ...
    DEMO_DUNGEON_DASH_REGION_GATE_REQUIREMENT, DEMO_DUNGEON_GLOVE_GATE_REQUIREMENT,
    DEMO_DUNGEON_GLOVE_PICKUP, DEMO_DUNGEON_GOAL_EXIT, DEMO_DUNGEON_START_ABILITIES,
    DEMO_DUNGEON_TOTAL_COINS, DEMO_DUNGEON_TREASURY_REQUIREMENT,
